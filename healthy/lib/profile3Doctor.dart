...
import 'package:healthy/DoctorStatics.dart';

import 'UserList.dart';

class profile4Doctor extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<profile4Doctor> {
  @override
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => DoctorVisualization()));
                },
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(
