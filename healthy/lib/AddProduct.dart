                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                            ...
                            onSaved: (value) {
                              formValues['monosaturated'] = value;
                            }),
                        Padding(
                          padding: const EdgeInsets.only(left: 10, right: 10),
                          child: Divider(
                        ...
                        TextFormField(
                            ...
                            onSaved: (value) {
                              formValues['polysaturated'] = value;
                            }),
                        Padding(
                          padding: const EdgeInsets.only(left: 10, right: 10),
                          child: Divider(
